...
These are the foundation of `iNEXT.4steps` Here we will also introduce functions about `STEP1`, `STEP4`, particularly. If you want to grasp `STEP1`, `STEP3`, then the related paper  T.C. Hsieh, K. H. Ma, and Chao, A. (2016) or the packages (`iNEXT.3D`) will be the best choice to you. 
...
- `Interplation and Extrapolation`: Chao, A., Gotelli, N. G., Hsieh, T. C., Sander, E. L., Ma, K. H., Colwell, R. K. and Ellison, A. M. (2014). Rarefaction and extrapolation with Hill numbers: a framework for sampling and estimation in species biodiversity studies. Ecological Monographs 84, 45-67. 
